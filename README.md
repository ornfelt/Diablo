...
Observe vcpkg step below:
git clone https://github.com/microsoft/vcpkg
cd vcpkg
bootstrap-vcpkg.bat
Now Add vcpkg path to environment variables. Add path and set new variable: VCPKG_ROOT to root of VCPKG...
vcpkg integrate install

Clone the project > open visual studio > open > cmake > select CMakeLists.txt in devilutionX dir.
